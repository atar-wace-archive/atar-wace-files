...
SUBJECTS=$(curl --retry 999 "https://web.archive.org/web/20160514162549/http://www.scsa.wa.edu.au/publications/past-wace-examinations" |
        grep "past-wace-examinations/" | 
        sed 's|.*past-wace-examinations/||;s|".*||'
    )
...
for SUBJECT in $SUBJECTS; do
    ...
    FILES=$(curl --retry 999 -Ls "https://web.archive.org/web/20160514162549/http://www.scsa.wa.edu.au/publications/past-wace-examinations/$SUBJECT" | 
