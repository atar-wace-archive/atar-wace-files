...
SUBJECTS=$(curl --retry 999 "https://web.archive.org/web/20111217081719/http://www.curriculum.wa.edu.au/internet/Publications/Past_WACE_Examinations" |
...
for SUBJECT in $SUBJECTS; do
    ...
    FILES=$(curl --retry 999 -Ls "web.archive.org/web/20110812172233/http://www.curriculum.wa.edu.au/internet/Publications/Past_WACE_Examinations/$SUBJECT" |
        grep -v "Publications_communications_WACE%20Manual%202011_web%20version.pdf" |
        grep 'href=\|<th ' |
        grep -i "<th\|\.mp3\|\.mp4\|\.doc\|\.docx\|\.pdf\|\.pptx\|\.wcm\|\.zip" |
        perl -pe 's|.*?curriculum|curriculum|;s|">[[<].*||;s|.*?>||;s| WACE.*th>|YEAR|'
    )
